...
namespace ZR.Admin.WebApi.Controllers.monitor
{
    ...
    public class MonitorController : BaseController
    {
        ...
        /// </summary>
        /// <returns></returns>
        [HttpGet("monitor/server1")]
        //[AllowAnonymous]
        public IActionResult Server1()
        {
            //核心数
        ...
        public IActionResult Server()
        {
            ...
            serverInfos.cpu = serverInfos.GetCpuInfos();
            serverInfos.mem = serverInfos.GetMem();
            serverInfos.sysFiles = serverInfos.GetDiskInfos();
            serverInfos.jvm = serverInfos.GetJvm();
            serverInfos.sys = serverInfos.GetSys(Request.HttpContext.Connection.LocalIpAddress.MapToIPv4().ToString() + ":" + Request.HttpContext.Connection.LocalPort, HostEnvironment.ContentRootPath);

            var data = serverInfos;
