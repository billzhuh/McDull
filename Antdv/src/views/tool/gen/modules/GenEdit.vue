      ...
      <a-tabs default-active-key="2">
        ...
        <a-tab-pane key="2" tab="字段信息" force-render>
          ...
          >
            ...
            <!-- Java类型 -->
            <template slot="csharpType" slot-scope="text, record" style="width:100%">
              <a-select v-model="record.csharpType">
            ...
            <!-- Java属性 -->
            <template slot="csharpField" slot-scope="text, record">
              <a-input v-model="record.csharpField"></a-input>
            </template>
            <!-- 插入 -->
    ...
    return {
      ...
      columns: [
        ...
        },
        {
          ...
          scopedSlots: { customRender: 'csharpType' },
          align: 'center',
          width: '10%'
        },
        {
          ...
          scopedSlots: { customRender: 'csharpField' },
          align: 'center',
          width: '10%'
        },
        {
  ...
  created () {
    ...
    if (this.tableId) {
      ...
      getGenTable(this.tableId).then(res => {
        const tableList = res.data.info.columns
