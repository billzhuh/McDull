    ...
    <div>
      <a-row :gutter="24">
        <a-col :xl="16" :lg="24" :md="24" :sm="24" :xs="24">
          ...
          >
            <p><b>RuoYi-Antdv</b>，使用<a href="" target="_blank">RuoYi-Vue</a>作为后端，改其原有Element Ui为Ant Design Vue。将会持续完全适配RuoYi-Vue。</p>
            <blockquote>
              <p>RuoYi-Vue是基于.net core 5，identityserver4，JWT，Vue Ant Design 的前后端分离权限管理系统。</p>
              <p>
      ...
      projects: [
        {
          logo: ruoyiLogo,
          name: 'Ant-Vue',
          description: '基于.net core 5，identityserver4，JWT，Vue & ant design 的前后端分离权限管理系统。',
